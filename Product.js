...
const Product = ({product}) => {
  ...
  return (
    <div>
      <div className='border border-[#e4e4e4] h-[300px] realtive overflow-hidden group transition'>
        < div className='w-full h-full flex justify-center items-center'>
         ...
         <div className='w-[200px] mx-auto flex justify-center items-center'>
          ...
          {/*buttons*/}
        <div className='top-6 right-11 group-hover:right-5 p-2 flex flex-col items-center justify-center gap-y-2 opacity-0 group-hover:opacity-100 tarsnition-all duration-300'>
